...
`;
        ...
        return {
            success: false,
            error: formatAiError(error, 'Study hints failed. Please try again.'),
            details: error.message
        };
    }
}
...
export async function getWordStudy(userId, verseRef, verseText, originalText, selectedWord = null, language = 'en') {
    try {
        ...
        return {
            success: false,
            error: formatAiError(error, 'Word study failed. Please try again.'),
            details: error.message
        };
    }
}
...
export async function getChapterSummary(userId, bookName, chapter, verses = [], language = 'en') {
    try {
        ...
        **Requirements:**
        ...
        return {
            success: false,
            error: formatAiError(error, 'Chapter summary failed. Please try again.'),
            details: error.message
        };
    }
}
...
`;
        ...
        return {
            success: false,
            error: formatAiError(error, 'Semantic search failed. Please try again.'),
            details: error.message
        };
    }
}
